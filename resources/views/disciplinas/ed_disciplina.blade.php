              ...
              <div class="col-sm-10 col-md-12">
                ...
                <div class="form-check">
                  <label class="form-check-label">
                    @if($disciplina->instrumento_id == $instrumento->id)
                    <input type="radio" class="form-check-input" name="instrumento_id" value="{{ $instrumento->id }}" checked>
                    @else
      ...
      <div class="col-sm-10 col-md-12">
        ...
        <div class="form-check">
          <label class="form-check-label">
            ...
            <input type="radio" class="form-check-input" name="professor_id" value="{{ $professor->id }}" checked>
            @else
